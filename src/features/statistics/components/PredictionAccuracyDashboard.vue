...
<template>
  <div class="dashboard-wrapper">
    ...
    <div class="prediction-tab-bar">
      <button :class="{ active: predictionType === 'sales' }"
              @click="predictionType = 'sales'; handleSearch()">매출</button>
      <button :class="{ active: predictionType === 'order_quantity' }"
              @click="predictionType = 'order_quantity'; handleSearch()">주문 수량</button>
      <button :class="{ active: predictionType === 'purchase_quantity' }"
              @click="predictionType = 'purchase_quantity'; handleSearch()">발주 수량</button>
    </div>
